...
const TOOL_TEXT: Record<string, { pending: string; done: string }> = {
  ...
  plan_add: { pending: 'Adding plan', done: 'Added plan' },
  plan_update: { pending: 'Updating plan', done: 'Updated plan' },
  plan_start: { pending: 'Starting plan', done: 'Started plan' },
  roadmap_view: { pending: 'Viewing roadmap', done: 'Viewed roadmap' },
  roadmap_add: { pending: 'Adding roadmap item', done: 'Added roadmap item' },
  roadmap_update: { pending: 'Updating roadmap item', done: 'Updated roadmap item' },
  roadmap_create_plan: { pending: 'Creating plan', done: 'Created plan' },
...
const TOOL_ICONS: Record<string, LucideIcon> = {
  ...
  plan_update: LayoutGrid, plan_start: LayoutGrid,
  roadmap_view: LayoutGrid, roadmap_add: LayoutGrid,
  roadmap_update: LayoutGrid, roadmap_create_plan: LayoutGrid,
