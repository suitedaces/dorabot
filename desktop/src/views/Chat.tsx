            ...
            <div className={cn('w-full mx-auto', compact ? 'space-y-3 px-4' : 'space-y-6 max-w-2xl px-6')}>
              ...
              <div className="text-center space-y-2">
                ...
                <div className="flex items-center justify-center gap-1.5 text-[11px] text-muted-foreground">
                  ...
                  {!connected ? 'connecting...' : !authenticated ? <>set up {activeProviderLabel} in <button type="button" className="underline hover:text-foreground transition-colors" onClick={onNavigateSettings}>Settings</button></> : 'ready'}
                </div>
              </div>
