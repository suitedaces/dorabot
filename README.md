<div align="center">
  ...
  **A 24/7 self-learning AI agent with a workspace that runs itself.**
  ...
  [**Download for macOS**](https://github.com/suitedaces/dorabot/releases/latest) · [Ubuntu from source](#build-from-source) · [Website](https://dora.so) · [Demo](https://github.com/suitedaces/dorabot/releases/download/v0.2.3/annotated-demo-telegram.mp4)
